...
std::vector<std::string> stream_army = { "candc_apartments", "candc_apartments", "candc_apartments", "candc_apartments", "candc_apartments" };
...
std::vector<std::string> Sport = { "ALPHA", "BANSHEE", "BESTIAGTS", "BLISTA2", "BLISTA3",
...
std::vector<std::string> army = { "BARRACKS", "BARRACKS2", "BARRACKS3", "CRUSADER", "RHINO" };
