...
namespace Big
{
	GameVariables::GameVariables() :
		...
		m_VectorFix(Signature("83 7A 18 00 75 B6").Scan().Sub(77).As<decltype(m_VectorFix)>()),
	...
	GameFunctions::GameFunctions() :
		m_FileRegister(Signature("4D 0F 45 F9").Scan().Sub(45).As<decltype(m_FileRegister)>()), //48 89 5C 24 ? 48 89 6C 24 ? 48 89 7C 24 ? 41 54 41 56 41 57 48 83 EC 50 48 8B EA 4C 8B FA 48 8B D9 4D 85 C9
