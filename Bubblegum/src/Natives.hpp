...
namespace Big
{
	...
	namespace MISC
	{
		static BOOL GET_GROUND_Z_FOR_3D_COORD(const Vector3& pos, float* groundZ, BOOL unk) { return invoke<BOOL>(0xC906A7DAB05C8D2B, pos, groundZ, unk); } // 0xC906A7DAB05C8D2B 0xA1BFD5E0
		static void REQUEST_COLLISION_AT_COORD(const Vector3& pos) { invoke<Void>(0x07503F7948F491A7, pos); } // 0x07503F7948F491A7 0xCD9805E7
		static void REQUEST_ADDITIONAL_COLLISION_AT_COORD(const Vector3& pos) { invoke<Void>(0xC9156DC11411A9EA, pos); } // 0xC9156DC11411A9EA 0xC2CC1DF2
		static Any GET_CLOSEST_ROAD(const Vector3& pos, float p3, int p4, Vector3* p5, Vector3* p6, int* p7, int* p8, float* p9, bool p10) { return invoke<Any>(0x132F52BBA570FE92, pos, p3, p4, p5, p6, p7, p8, p9, p10); }
	...
	namespace VEHICLE
	{
		...
		static Vehicle CREATE_VEHICLE1(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xAF35D0D2583051B0 0xDD75460A
